...
void print_intro()
{
	...
	printf("\nThe result format is: test_name-test_number-tested_instr:avg_ticks\n");
}


void print_results(char * name, int num, char * instr, double result)
{
	printf("%s-%d-%s: %f\n", name, num, instr, result);
}
...
void baseline_tests(uint64_t n)
{
	...
	print_results("baseline_xsave", 1, "xsave64", (double)save_sum/n);
	print_results("baseline_xsave", 1, "xrstor64", (double)rstr_sum/n);
	...
	print_results("baseline_xsaveopt", 1, "xsaveopt64", (double)save_sum/n);
	print_results("baseline_xsaveopt", 1, "xrstor64", (double)rstr_sum/n);
}
...
void x87_tests(uint64_t n)
{
	...
	print_results("x87_xsave", 2, "xsave64", (double)save_sum/n);
	print_results("x87_xsave", 2, "xrstor64", (double)rstr_sum/n);
	...
	print_results("x87_xsaveopt", 2, "xsaveopt64", (double)save_sum/n);
	print_results("x87_xsaveopt", 2, "xrstor64", (double)rstr_sum/n);
	...
	print_results("x87_xsave", 3, "xsave64", (double)save_sum/n);
	print_results("x87_xsave", 3, "xrstor64", (double)rstr_sum/n);
	...
	print_results("x87_xsaveopt", 3, "xsaveopt64", (double)save_sum/n);
	print_results("x87_xsaveopt", 3, "xrstor64", (double)rstr_sum/n);
	...
	print_results("x87_xsave", 4, "xsave64", (double)save_sum/n);
	print_results("x87_xsave", 4, "xrstor64", (double)rstr_sum/n);
	...
	print_results("x87_xsaveopt", 4, "xsaveopt64", (double)save_sum/n);
	print_results("x87_xsaveopt", 4, "xrstor64", (double)rstr_sum/n);
}
...
void xmm_tests(uint64_t n)
{
	...
	print_results("xmm_xsave", 2, "xsave64", (double)save_sum/n);
	print_results("xmm_xsave", 2, "xrstor64", (double)rstr_sum/n);
	...
	print_results("xmm_xsaveopt", 2, "xsaveopt64", (double)save_sum/n);
	print_results("xmm_xsaveopt", 2, "xrstor64", (double)rstr_sum/n);
	...
	print_results("xmm_xsave", 3, "xsave64", (double)save_sum/n);
	print_results("xmm_xsave", 3, "xrstor64", (double)rstr_sum/n);
	...
	print_results("xmm_xsaveopt", 3, "xsaveopt64", (double)save_sum/n);
	print_results("xmm_xsaveopt", 3, "xrstor64", (double)rstr_sum/n);
	...
	print_results("xmm_xsave", 4, "xsave64", (double)save_sum/n);
	print_results("xmm_xsave", 4, "xrstor64", (double)rstr_sum/n);
	...
	print_results("xmm_xsaveopt", 4, "xsaveopt64", (double)save_sum/n);
	print_results("xmm_xsaveopt", 4, "xrstor64", (double)rstr_sum/n);
}
void hi_ymm_tests(uint64_t n)
{
	...
	print_results("hi_ymm_xsave", 2, "xsave64", (double)save_sum/n);
	print_results("hi_ymm_xsave", 2, "xrstor64", (double)rstr_sum/n);
	...
	print_results("hi_ymm_xsaveopt", 2, "xsaveopt64", (double)save_sum/n);
	print_results("hi_ymm_xsaveopt", 2, "xrstor64", (double)rstr_sum/n);
	...
	print_results("hi_ymm_xsave", 3, "xsave64", (double)save_sum/n);
	print_results("hi_ymm_xsave", 3, "xrstor64", (double)rstr_sum/n);
	...
	print_results("hi_ymm_xsaveopt", 3, "xsaveopt64", (double)save_sum/n);
	print_results("hi_ymm_xsaveopt", 3, "xrstor64", (double)rstr_sum/n);
	...
	print_results("hi_ymm_xsave", 4, "xsave64", (double)save_sum/n);
	print_results("hi_ymm_xsave", 4, "xrstor64", (double)rstr_sum/n);
	...
	print_results("hi_ymm_xsaveopt", 4, "xsaveopt64", (double)save_sum/n);
	print_results("hi_ymm_xsaveopt", 4, "xrstor64", (double)rstr_sum/n);
}
void xmm_x87_tests(uint64_t n)
{
	...
	print_results("xmm_x87_xsave", 2, "xsave64", (double)save_sum/n);
	print_results("xmm_x87_xsave", 2, "xrstor64", (double)rstr_sum/n);
	...
	print_results("xmm_x87_xsaveopt", 2, "xsaveopt64", (double)save_sum/n);
	print_results("xmm_x87_xsaveopt", 2, "xrstor64", (double)rstr_sum/n);
	...
	print_results("xmm_x87_xsave", 3, "xsave64", (double)save_sum/n);
	print_results("xmm_x87_xsave", 3, "xrstor64", (double)rstr_sum/n);
	...
	print_results("xmm_x87_xsaveopt", 3, "xsaveopt64", (double)save_sum/n);
	print_results("xmm_x87_xsaveopt", 3, "xrstor64", (double)rstr_sum/n);
	...
	print_results("xmm_x87_xsave", 4, "xsave64", (double)save_sum/n);
	print_results("xmm_x87_xsave", 4, "xrstor64", (double)rstr_sum/n);
	...
	print_results("xmm_x87_xsaveopt", 4, "xsaveopt64", (double)save_sum/n);
	print_results("xmm_x87_xsaveopt", 4, "xrstor64", (double)rstr_sum/n);
}
...
void hi_ymm_xmm_tests(uint64_t n)
{
	...
	print_results("hi_ymm_xmm_xsave", 2, "xsave64", (double)save_sum/n);
	print_results("hi_ymm_xmm_xsave", 2, "xrstor64", (double)rstr_sum/n);
	...
	print_results("hi_ymm_xmm_xsaveopt", 2, "xsaveopt64", (double)save_sum/n);
	print_results("hi_ymm_xmm_xsaveopt", 2, "xrstor64", (double)rstr_sum/n);
	...
	print_results("hi_ymm_xmm_xsave", 3, "xsave64", (double)save_sum/n);
	print_results("hi_ymm_xmm_xsave", 3, "xrstor64", (double)rstr_sum/n);
	...
	print_results("hi_ymm_xmm_xsaveopt", 3, "xsaveopt64", (double)save_sum/n);
	print_results("hi_ymm_xmm_xsaveopt", 3, "xrstor64", (double)rstr_sum/n);
	...
	print_results("hi_ymm_xmm_xsave", 4, "xsave64", (double)save_sum/n);
	print_results("hi_ymm_xmm_xsave", 4, "xrstor64", (double)rstr_sum/n);
	...
	print_results("hi_ymm_xmm_xsaveopt", 4, "xsaveopt64", (double)save_sum/n);
	print_results("hi_ymm_xmm_xsaveopt", 4, "xrstor64", (double)rstr_sum/n);
}
...
void hi_ymm_x87_tests(uint64_t n)
{
	...
	print_results("hi_ymm_x87_xsave", 2, "xsave64", (double)save_sum/n);
	print_results("hi_ymm_x87_xsave", 2, "xrstor64", (double)rstr_sum/n);
	...
	print_results("hi_ymm_x87_xsaveopt", 2, "xsaveopt64", (double)save_sum/n);
	print_results("hi_ymm_x87_xsaveopt", 2, "xrstor64", (double)rstr_sum/n);
	...
	print_results("hi_ymm_x87_xsave", 3, "xsave64", (double)save_sum/n);
	print_results("hi_ymm_x87_xsave", 3, "xrstor64", (double)rstr_sum/n);
	...
	print_results("hi_ymm_x87_xsaveopt", 3, "xsaveopt64", (double)save_sum/n);
	print_results("hi_ymm_x87_xsaveopt", 3, "xrstor64", (double)rstr_sum/n);
	...
	print_results("hi_ymm_x87_xsave", 4, "xsave64", (double)save_sum/n);
	print_results("hi_ymm_x87_xsave", 4, "xrstor64", (double)rstr_sum/n);
	...
	print_results("hi_ymm_x87_xsaveopt", 4, "xsaveopt64", (double)save_sum/n);
	print_results("hi_ymm_x87_xsaveopt", 4, "xrstor64", (double)rstr_sum/n);
...
void hi_ymm_xmm_x87_tests(uint64_t n)
{
	...
	print_results("hi_ymm_xmm_x87_xsave", 2, "xsave64", (double)save_sum/n);
	print_results("hi_ymm_xmm_x87_xsave", 2, "xrstor64", (double)rstr_sum/n);
	...
	print_results("hi_ymm_xmm_x87_xsaveopt", 2, "xsaveopt64", (double)save_sum/n);
	print_results("hi_ymm_xmm_x87_xsaveopt", 2, "xrstor64", (double)rstr_sum/n);
	...
	print_results("hi_ymm_xmm_x87_xsave", 3, "xsave64", (double)save_sum/n);
	print_results("hi_ymm_xmm_x87_xsave", 3, "xrstor64", (double)rstr_sum/n);
	...
	print_results("hi_ymm_xmm_x87_xsaveopt", 3, "xsaveopt64", (double)save_sum/n);
	print_results("hi_ymm_xmm_x87_xsaveopt", 3, "xrstor64", (double)rstr_sum/n);
	...
	print_results("hi_ymm_xmm_x87_xsave", 4, "xsave64", (double)save_sum/n);
	print_results("hi_ymm_xmm_x87_xsave", 4, "xrstor64", (double)rstr_sum/n);
	...
	print_results("hi_ymm_xmm_x87_xsaveopt", 4, "xsaveopt64", (double)save_sum/n);
	print_results("hi_ymm_xmm_x87_xsaveopt", 4, "xrstor64", (double)rstr_sum/n);
}
